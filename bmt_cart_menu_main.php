...
*/
	...
	<!-- top yellow box on settings page -->
	    <div class="bmt_yellow_box">
	        ...
	        <a href="https://www.bmtmicro.com/" target="_blank"><?php _e("BMT Micro, Inc.", "wordpress-simple-paypal-shopping-cart"); ?></a><br />
					<p><?php _e("For more information about the BMT Micro plugin, please visit:", "wordpress-simple-paypal-shopping-cart"); ?><br />
	        <a href="https://help.bmtmicro.com/plugin" target="_blank"><?php _e("BMT Micro Plugin", "wordpress-simple-paypal-shopping-cart"); ?></a><br />
