...
*/
	...
	<!-- top yellow box on settings page -->
	    <div class="bmt_yellow_box">
	        ...
	        <a href="https://www.bmtmicro.com/new-vendors/" target="_blank"><?php _e("BMT Micro Vendor Page", "wordpress-simple-paypal-shopping-cart"); ?></a><br /><br />
	...
	<!-- ************ -->
	    ...
	    <div class="postbox">
	    	...
	    	<div class="inside">
	    		...
	    		</p><p><?php _e("Example 'Buy Now' button shortcode usage:", "wordpress-simple-paypal-shopping-cart");?> <p style="background-color: #DDDDDD; padding: 5px; display: inline;">[bmt_buy_now _button product_id="0000"]</p></p>
